...
Scripts:AddButton({
	Name = "Give 10 power { Use While Glovel Killer Turned On }",
	Callback = function()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
...
Scripts:AddButton({
	Name = "Give 100 power { Use While Glovel Killer Turned On }",
	Callback = function()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
game:GetService("ReplicatedStorage").GlovelFunc:InvokeServer()
...
Scripts:AddToggle({
	Name = "Glovel Killer Anti-Lag { a bit less lags, almost no difference }",
  	Default = false,
	Callback = function(Value)
_G.AntiLag = Value
while _G.AntiLag do
